...
$master_secret = 'ccaa821f8113c80c8c13239f';
$app_key='bdcb5b1fce8f39cc8b577744';
...
try {
    $result = $client->push()
        ->setPlatform(M\all)
        ->setAudience(M\all)
        ->setNotification(M\notification('hello, JPushskdhfsjhfkshfkjhjshdjfhsjkhfsdkjhfksjhfskjhfsjhfsjhfsjhjhskdhfskjhfjskhfdksjhfjkshfdjsdhfsjhdfdjshf'))
        ->printJSON()
        ->send();
