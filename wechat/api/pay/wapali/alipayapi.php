...
//服务器异步通知页面路径
$notify_url = $alipay_config['feedbackUrl']."/pay/wapali/notify_url.php";
//需http://格式的完整路径，不允许加?id=123这类自定义参数

//页面跳转同步通知页面路径
$call_back_url = $alipay_config['feedbackUrl']."/pay/wapali/call_back_url.php";
//需http://格式的完整路径，不允许加?id=123这类自定义参数

//操作中断返回地址
$merchant_url = "http://m.xiaoniubang.com";
