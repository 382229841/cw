 ...
 *Yii::app()->params['encryptKey'] 换成你对应的默认key就可以了
 * @author Terry
 *
 */
class phpaes {
     ...
     * @param string $key
     */
    private $beginKey='suzhoubankapp001';
    public static function AesEncrypt($plaintext,$key = null)
    {
        ...
        $key=self::substr($key===null ? 'suzhoubankapp001' : $key, 0, mcrypt_enc_get_key_size($module));
    ...
    public static function AesDecrypt($encrypted, $key = null)
    {
        ...
        $iv = "BOCDBOCDBOCDBOCD";//substr(md5($key),0,mcrypt_enc_get_iv_size($module));
